...
# Script de PowerShell que obtiene informaci贸n basica de un equipo

# lo guarda en un archivo csv

# Posteriormente envia ese archivo a trav茅s de correo electronico
...
# Llenando arraya para generaci贸n de csv
...
$Password = "CONTRASE袮AA";      # Aqui va tu password de aplicaci贸n
...
function Send-ToEmail([string]$email, [string]$attachmentpath){
    ...
    $message.Subject = "Env铆o de informaci贸n del equipo."; #Asunto del correo
